...
export const useHeaderItemsStore = defineStore('headerItems', () => {
  ...
  const socialLinks = ref([

    {
      ...
      icon_dark:'./src/assets/icons/footer/facebook-icon.svg',
      link:'/',
...

    {
      ...
      icon_dark:'./src/assets/icons/footer/twitter-icon.svg',
      link:'/',
...

    {
      ...
      icon_dark:'./src/assets/icons/footer/instagram-icon.svg',
      link:'/',
...

    {
      ...
      icon_dark:'./src/assets/icons/footer/youtube-icon.svg',
      link:'/',
...

    {
      ...
      icon_dark:'./src/assets/icons/footer/google-sheets-icon.svg',
      link:'/',
...

    {
      ...
      icon_dark:'./src/assets/icons/footer/share-icon.svg',
      link:'/',
